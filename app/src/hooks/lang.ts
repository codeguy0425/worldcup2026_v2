export const en = {
  ...
  home: { phaseGroup: 'Group stage — {played}/{total} played', phaseKnockout: (p: string) => `${p} underway`, latest: 'Latest Results', upcoming: 'Upcoming', noResults: 'No matches played yet', finalStandings: 'Final Standings', goldenBoot: 'Golden Boot', goals: 'goals' },
...
export const zh = {
  ...
  home: { phaseGroup: '分組賽 — {played}/{total} 已賽', phaseKnockout: (p: string) => `🏁 ${p} 進行中`, latest: '最新賽果', upcoming: '即將舉行', noResults: '暫無比賽', finalStandings: '最終排名', goldenBoot: '金靴獎', goals: '球' },
