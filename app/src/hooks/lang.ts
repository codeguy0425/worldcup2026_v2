export const en = {
  ...
  match: { back: '← Back to schedule', backBracket: '← Back to bracket', winner: 'Winner', loser: 'Loser', lineup: 'LINE UP', subs: 'Substitutions', cards: 'Cards', subsBench: 'subs', coach: 'Coach' },
...
export const zh = {
  ...
  match: { back: '← 返回賽程', backBracket: '← 返回淘汰賽', winner: '勝方', loser: '敗方', lineup: '正選陣容', subs: '換人', cards: '牌', subsBench: '後備', coach: '教練' },
